...
Список всіх визначень та скорочень міститься у [посиланні](https://github.com/NothingIsMatter/database_basics_template/blob/master/docs/requirements/state-of-the-art.md#основні-визначення) на відповідний пункт Аналізу предметної області.
