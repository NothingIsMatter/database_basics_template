...
-аналітик - відповідає за створення опитування і його відповідність ТЗ, експерту опитування
...
+ працівник контактного-центру(менеджер) - міст між замовником та експертами і респонентами.
+ Експерт - відповідає за створення опитування, його відповідність технічному завданню, надає експерту по опитуванні
...
***УЧАСНИКИ:*** Замовник, працівник контактного-центру(менеджер), експерти
...
+ 3.Менеджер узгоджує з експертами та замовником технічне завдання опитування, можливість його реалізації, корректність вимог.
<hr>
...
***ОСНОВНИЙ СЦЕНАРІЙ:*** 
+ 1.Менедждер передає технічне завдання експерту.
+ 2.Експерт створює опитування.
+ 3.Експерт предає створене опитування менеджеру.
<hr>
...
+ ЕХC.004-V1  Експерти не в змозі обробити результати

***ОСНОВНИЙ СЦЕНАРІЙ:*** 
+ 1.експерт оброблює відповіді.
+ 2.Аналіт створює звіт з результатами, аналітикою опитування з обробленої інформації.
+ 3.експерт предає звіт менеджеру.
<hr>
...
***ПЕРЕДУМОВИ:*** Опитування опрацьоване експертами 
